...
<div className="not-prose mt-6 flex flex-wrap gap-3">
  <a className="inline-flex items-center justify-center rounded-lg bg-[#107C10] px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#0D660D] dark:bg-[#10B25C] dark:text-zinc-950 dark:hover:bg-[#0FA454]" href="/gdk/get-started">
    Open Quickstart
  </a>

  <a className="inline-flex items-center justify-center rounded-lg border border-zinc-300 px-5 py-2.5 text-sm font-semibold text-zinc-700 transition-colors hover:border-[#107C10] hover:text-[#107C10] dark:border-zinc-700 dark:text-zinc-200 dark:hover:border-[#10B25C] dark:hover:text-[#10B25C]" href="/onboarding">
    Onboarding
  </a>
</div>